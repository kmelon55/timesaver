...
newTableData[4][2] = <button className='monday'
            style={isVisible[6]?{display:'none'}:{ height: '75px', backgroundColor: 'green' , display:'block'}} disabled>
            디지털신호처리
            </button>
